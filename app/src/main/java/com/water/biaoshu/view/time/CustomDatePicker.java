package com.water.biaoshu.view.time;
...
public class CustomDatePicker extends DatePicker
{
    ...
    public CustomDatePicker(Context context, AttributeSet attrs)
    {
        ...
        try
        {
            ...
            selectionDividerField.set(monthNumberPicker, getResources().getDrawable(R.mipmap.selection_divider));
            selectionDividerField.set(dayNumberPicker, getResources().getDrawable(R.mipmap.selection_divider));
            selectionDividerField.set(yearNumberPicker, getResources().getDrawable(R.mipmap.selection_divider));
        }
