...
import com.water.biaoshu.activity.BaseActivity;
import com.water.biaoshu.utils.photo.AlbumHelper;
import com.water.biaoshu.utils.photo.Bimp;
import com.water.biaoshu.utils.photo.BitmapCache;
import com.water.biaoshu.utils.photo.ImageBucket;
	...
	class ImageGridAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			if (item.isSelected) {
				...
				holder.selected.setImageResource(R.mipmap.select_yes);
			} else {
